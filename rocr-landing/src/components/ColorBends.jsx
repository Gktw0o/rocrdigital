  ...
  useEffect(() => {
    ...
    const handlePointerMove = e => {
      ...
      if (pointerTarget === "window") {
        ...
        xNDC = (e.clientX / w) * 2 - 1;
        yNDC = -((e.clientY / h) * 2 - 1);
      } else {
        const rect = container.getBoundingClientRect();
        xNDC = ((e.clientX - rect.left) / (rect.width || 1)) * 2 - 1;
        yNDC = -(((e.clientY - rect.top) / (rect.height || 1)) * 2 - 1);
      }
      pointerTargetRef.current.set(xNDC, yNDC);
    };
